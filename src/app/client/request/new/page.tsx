...
import { ChevronLeft, Loader2, MapPin, Wrench, DollarSign, Sparkles } from "lucide-react";
...
export default function NewRequestPage() {
    ...
    return (
        <div className="min-h-screen p-6 max-w-2xl mx-auto pt-24">
            ...
            >
                <div className="mb-8">
                    <h1 className="text-3xl font-extrabold mb-2 text-glow">Name Your Price</h1>
                    <p className="text-[var(--color-text-secondary)]">Technicians around you will see your offer and either accept or counter-bid.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {['maintenance', 'cleaning', 'concierge', 'transport'].map((type) => (
                                <button
                                    key={type}
                                    type="button"
                    ...
                    <div className="space-y-3 pt-4 border-t border-[var(--color-glass-border)]">
                        ...
                        <p className="text-xs text-[var(--color-text-secondary)]">Technicians might counter-offer. You choose who to hire.</p>
                    </div>
                    ...
                    >
                        {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : "Request Service Now"}
                    </button>
                </form>
            </motion.div>
        </div>
