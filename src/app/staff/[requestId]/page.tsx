                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 'checkout' && (
                        ...
                        >
                            ...
                            <div
                                onClick={handlePhoto}
                                className="border-3 border-dashed border-gray-200 rounded-3xl h-64 flex flex-col items-center justify-center bg-gray-50 cursor-pointer hover:bg-gray-100 active:scale-95 transition-all"
                            >
                                ...
                                {evidence.length > 0 && (
                                    <p className="text-emerald-600 font-bold text-sm mt-2">{evidence.length} Fotos Guardadas</p>
                                )}
                            </div>
