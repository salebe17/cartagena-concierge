...
export function HostMessagesView({ bookings, currentUserId, userName }: HostMessagesViewProps) {
    return (
        <div className="fixed inset-x-0 top-0 bottom-[85px] z-40 flex flex-col bg-white pb-0 md:static md:h-[calc(100vh-140px)] md:bg-transparent md:inset-auto md:z-auto animate-in fade-in duration-500">
            {/* Header */}
