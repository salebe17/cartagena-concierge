...
export function HostMessagesView({ bookings, currentUserId, userName }: HostMessagesViewProps) {
    return (
        <div className="fixed inset-0 z-40 pb-[80px] flex flex-col bg-white md:static md:h-[calc(100vh-140px)] md:bg-transparent md:pb-0 md:z-auto animate-in fade-in duration-500">
            {/* Header */}
